...
# Portfolio data - Projects for Pavan kumar Katineni
PORTFOLIO_ITEMS = [
    {
        'id': 1,
        'title': 'Hotel Reservation & Cancellation Prediction',
        'description': 'Machine learning project that predicts hotel booking cancellations before check-in to help reduce revenue loss and optimize operations.',
        'image': 'hotel_project.jpg',
        'technologies': ['Python', 'Pandas', 'Scikit-learn', 'SQL', 'Flask'],
        'keyFeatures': [
            'Analyzed features like lead time, deposit type, and customer behavior',
            'Built models: Logistic Regression, Decision Tree, Random Forest',
            'Improved operational decision-making and reduced potential revenue loss',
            'Data preprocessing, feature engineering and model evaluation'
        ]
    },
    {
        'id': 2,
        'title': 'E-Commerce Management System (Demo)',
        'description': 'Full-stack demo app for product and order management with a normalized SQL schema and simple authentication.',
        'image': 'project2.jpg',
    ...
    },
    {
        ...
        'description': 'Collection of small data science experiments showcasing preprocessing, visualization and predictive modeling.',
        'image': 'project3.jpg',
...
SKILLS = {
    ...
    'Core Concepts': ['Data Structures & Algorithms', 'OOP', 'Database Design', 'Web Development']
}
